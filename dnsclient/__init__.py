...
def _get_dnsclient_version():
    """Read version from versioninfo file."""
    mod_abspath = inspect.getabsfile(inspect.currentframe())
    dnsclient_path = os.path.dirname(mod_abspath)
    version_path = os.path.join(dnsclient_path, 'versioninfo')
...
__version__ = _get_dnsclient_version()