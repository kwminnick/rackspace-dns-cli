...
"""
Rackspace DNS Client interface. Handles the REST calls and responses.
"""
...
from dnsclient import service_catalog
...
def get_client_class(version):
    version_map = {
        '1.0': 'dnsclient.v1_0.client.Client',
    }
    try:
